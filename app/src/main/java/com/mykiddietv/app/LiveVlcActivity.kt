...
class LiveVlcActivity : AppCompatActivity() {
    ...
    private inner class EpgRailAdapter : androidx.recyclerview.widget.RecyclerView.Adapter<EpgRailAdapter.VH>() {
        inner class VH(val v: com.mykiddietv.app.databinding.ItemEpgRailBinding) :
            androidx.recyclerview.widget.RecyclerView.ViewHolder(v.root)
        override fun onCreateViewHolder(parent: android.view.ViewGroup, viewType: Int) =
            VH(com.mykiddietv.app.databinding.ItemEpgRailBinding.inflate(layoutInflater, parent, false))
        ...
        override fun onBindViewHolder(holder: VH, position: Int) {
            ...
            holder.v.epgTime.setTextColor(if (live) 0xFF1A1A1A.toInt() else 0xFF9FB0C0.toInt())
