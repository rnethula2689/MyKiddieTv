...
/**
 * Salted-hash storage + brute-force lockout for the parental PIN / kid passcode.
 *
 * - [hash]/[verify] use PBKDF2-HMAC-SHA1 (API 21+) with a random per-secret salt, so the code is never
 ...
 * - [lockedMs]/[recordFail]/[recordSuccess] add an escalating lockout after repeated wrong entries so a
 *   4-digit code can't be brute-forced through the UI.
 */
object Secret {
