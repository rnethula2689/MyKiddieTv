...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun showKidNamesDialog() {
        ...
        val box = LinearLayout(this).apply {
            ...
            addView(parent); addView(kid); addView(pin)
        }
        AlertDialog.Builder(this)
    ...
    // ---- Parental PIN (adult channel lock) ----
    ...
    /** Wipe the per-title saved subtitles picked from online subtitle search. */
    private fun confirmClearSubs() {
        ...
        AlertDialog.Builder(this)
            ...
            .setMessage("Remove $n saved subtitle${if (n == 1) "" else "s"} (${bytes / 1024} KB)? Movies can search and download again next time you turn subtitles on.")
            .setNegativeButton("Cancel", null)
